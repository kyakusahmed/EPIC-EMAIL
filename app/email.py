...
class Emails:
    ...
    def get_user_email(self, user_id):
        """get user email."""
        emails = [
            item for item in self.emails if item['receiver_id'] == user_id]
        return emails
    ...
    def get_user_unread_email(self, user_id, read):
        ...
        emails = [
            ...
            if item['receiver_id'] == user_id if item['read'] == False]
        return emails
    ...
    def get_specific_user_email(self, id, email_id):
        email = [
            ...
            if email['sender_id'] == id or email['email_id'] == email_id]
        return email
